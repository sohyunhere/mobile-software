    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final int pos = i;
                String msg = foodList.get(i).getFood()+"을(를) 삭제하시겠습니까?";
            ...
            case R.id.button:
                ...
                builder.setTitle("음식 추가")
                        ...
                        .setPositiveButton("추가", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                EditText foodName = addLayout.findViewById(R.id.foodName);
                                EditText foodCountry = addLayout.findViewById(R.id.foodCountry);

                                //원본데이터에 추가
                                foodManager.addFood(new Food(foodName.getText().toString(), foodCountry.getText().toString()));
                                //새로고침
                                adapter.notifyDataSetChanged();
                            }
                        })
